...
linkage backbone for all other modules. When merging background variables
with survey data:
...
files carry the period in their filename rather than as a column, so
you need to tag each file before stacking:
