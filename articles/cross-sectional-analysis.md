...
income. These live in the Background Variables module (CA), not in the
survey module itself.
...
You report the wave identifier (e.g. ch24q) and the LISS data version
