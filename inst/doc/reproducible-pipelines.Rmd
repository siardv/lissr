...
> `ch_custom.yml` (recipe version 1.0.0, schema version 1.0.0).
> Sentinel codes were recoded to NA per rules H01–H03. Self-rated
> health items (suffix 001) were pooled across all 17 waves; e-cigarette
> items (suffixes 265–267) were restricted to waves ch15h–ch24q per
